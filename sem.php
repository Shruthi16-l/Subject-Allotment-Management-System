                        ...
                        <tbody>
                            ...
                            if(isset($_GET['id'])) {
                                ...
                                if ($stmt_semester) {
                                    ...
                                    // Fetch subjects related to the selected semester
                                    $stmt = $admin->ret("SELECT s.*, sem.SemesterName FROM subject s 
                                                        INNER JOIN semester sem ON s.CourseID = sem.ID 
                                    ...
                                    if ($stmt) {
                                        ...
                                        echo "<tr><td colspan='7'>No subjects found for the selected semester.</td></tr>";
                                    }
                                } else {
                                    // Semester ID not found in database
                                    echo "<tr><td colspan='7'>Semester ID not found.</td></tr>";
                                }
                            } else {
                                // Semester ID not provided in URL
                                echo "<tr><td colspan='7'>Semester ID not provided.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
